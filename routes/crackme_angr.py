...
def main():
  path_to_binary = r"C:\Users\kenne\Downloads\starter (1)\starter\home\crackme"
  ...
  def is_successful(state):
    ...
    # (!)
    return b'Your copy of Windows 95 is activated.' in stdout_output  # :boolean
  ...
  def should_abort(state):
    stdout_output = state.posix.dumps(sys.stdout.fileno())
    return b'Invalid CD Key.' in stdout_output  # :boolean
